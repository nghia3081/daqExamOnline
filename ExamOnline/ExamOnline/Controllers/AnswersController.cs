...
namespace ExamOnline.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public AnswersController(ExamOnlineContext context)
        {
            _context = context;
        }
        ...
        {
            var examOnlineContext = _context.Answers.Include(a => a.Question);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Content,QuestionId")] Answer answer)
        {
            if (id != answer.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'ExamOnlineContext.Answers'  is null.");
            }
            var answer = await _context.Answers.FindAsync(id);
            if (answer != null)
            {
